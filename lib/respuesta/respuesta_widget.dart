...
class RespuestaWidget extends StatefulWidget {
  const RespuestaWidget({Key key}) : super(key: key);

  @override
  _RespuestaWidgetState createState() => _RespuestaWidgetState();
}
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  Text(
                    'GRACIAS POR CONTACTARNOS ESTAR PENDIENTE POR ALGUNA NOTIFICACION',
                    textAlign: TextAlign.center,
